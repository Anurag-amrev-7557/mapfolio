...
interface MapState {
  ...
  setSunPolarAngle: (polarAngle: number) => void;
...
// High-performance Zustand state selectors to prevent unnecessary component re-renders
export const selectViewport = (state: MapState) => ({
  lat: state.lat,
  lng: state.lng,
  zoom: state.zoom,
  pitch: state.pitch,
...
export const selectTypography = (state: MapState) => ({
  title: state.title,
  ...
  setLetterSpacingMultiplier: state.setLetterSpacingMultiplier,
});

export const selectThemeState = (state: MapState) => ({
  themeId: state.themeId,
  colorOverrides: state.colorOverrides,
  customThemes: state.customThemes,
  setTheme: state.setTheme,
  setColorOverride: state.setColorOverride,
  resetColorOverrides: state.resetColorOverrides,
  saveCustomTheme: state.saveCustomTheme,
  deleteCustomTheme: state.deleteCustomTheme,
});

export const selectRouteState = (state: MapState) => ({
  route: state.route,
  isDrawingRoute: state.isDrawingRoute,
  routeWaypoints: state.routeWaypoints,
  routingProfile: state.routingProfile,
  routePreference: state.routePreference,
  setRouteGeoJson: state.setRouteGeoJson,
  setRouteColor: state.setRouteColor,
  setRouteWidth: state.setRouteWidth,
  setRouteLineStyle: state.setRouteLineStyle,
  setRouteWaypointSize: state.setRouteWaypointSize,
  toggleElevationProfile: state.toggleElevationProfile,
  clearRoute: state.clearRoute,
  setIsDrawingRoute: state.setIsDrawingRoute,
  addRouteWaypoint: state.addRouteWaypoint,
  removeRouteWaypoint: state.removeRouteWaypoint,
  clearRouteWaypoints: state.clearRouteWaypoints,
  setRoutingProfile: state.setRoutingProfile,
  setRoutePreference: state.setRoutePreference,
});

export const selectMarkersState = (state: MapState) => ({
  markers: state.markers,
  activeMarkerSettings: state.activeMarkerSettings,
  customMarkers: state.customMarkers,
  setActiveMarkerSettings: state.setActiveMarkerSettings,
  addMarker: state.addMarker,
  updateMarker: state.updateMarker,
  deleteMarker: state.deleteMarker,
  clearMarkers: state.clearMarkers,
  addCustomMarker: state.addCustomMarker,
  removeCustomMarker: state.removeCustomMarker,
});

export const selectLayerVisibility = (state: MapState) => ({
